...
const sampleUsers = [
  ...
  {
    id: 'user2', 
    email: '2019876543@student.wits.ac.za',
    firstName: 'Sarah',
    lastName: 'Johnson',
    phone: '+27987654321',
  ...
  {
    id: 'user5',
    email: '2021123456@student.uj.ac.za', 
    firstName: 'David',
    lastName: 'Brown',
    phone: '+27333456789',
  ...
  {
    id: 'user6',
    email: '220089765@student.sun.ac.za', 
    firstName: 'Emma',
    lastName: 'Wilson',
    phone: '+27222345678',
...
async function main() {
  console.log('🌱 Starting database seeding with multiple universities...')
  ...
  // Create users
  console.log('👥 Creating users from multiple universities...')
  ...
  console.log(`Created ${sampleUsers.length} users from multiple universities`)
  console.log(`Created ${sampleCategories.length} categories`)
  console.log(`Created ${sampleProducts.length} products`)
  
  console.log('\n🎓 Universities represented:')
  const universities = [...new Set(sampleUsers.map(u => u.university))]
  universities.forEach(uni => console.log(`  • ${uni}`))
}
