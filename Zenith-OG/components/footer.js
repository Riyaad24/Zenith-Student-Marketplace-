    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              A safe, affordable, and accessible marketplace for university and college students in South Africa.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">support@zenithmarketplace.co.za</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; 2025 Zenith Student Marketplace. All rights reserved. Made with ❤️ for South African students.</p>
        </div>
      </div>
    </footer>
  )
